...
/**
 * Classe VHome, estende la classe view e gestisce la visualizzazione e 
 * formattazione del sito, inoltre imposta i principali contenuti della pagina, 
 * suddivisi in contenuti principali (main_content) e contenuti della barra 
 * laterale (side_content)
 */
class VHome extends View {
    ...
    public function mostraPagina() {
        ...
        $this->display('index'.$this->_layout.'.tpl');
    }
    /**
    ...
    public function impostaPaginaGuest() {
        global $config;
        $this->assign('title',$config['nomeClinica']);
