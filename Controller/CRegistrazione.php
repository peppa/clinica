 ...
 * @access public
 * @package Controller
 * @todo getUtenteRegistrato Deve restituire il tipo di utente in caso sia registrato!!
 */
class CRegistrazione {
     ...
     * regirtrato ed in tal caso impostano le variabili di sessione relative 
     * all'autenticazione
     *
